            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="chart">
                                <canvas id="doctor" style="min-height: 250px; height: 420px; max-height: 420px; max-width: 100%;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="chart">
                                <canvas id="labtech1" style="min-height: 250px; height: 420px; max-height: 420px; max-width: 100%;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="chart">
                                <canvas id="labtech2" style="min-height: 250px; height: 420px; max-height: 420px; max-width: 100%;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
